...
//  Happiness
//
//  Created by Sriharshaa Sammeta on 2/10/15.
...
class FaceView: UIView {
    ...
    private func bezierPathForEye(whichEye: Eye)->UIBezierPath{
        ...
        let eyeHorizontolSeperation = faceRadius / Scaling.FaceRadiusToEyeSeparationRatio
        
        var eyeCenter = faceCenter
        eyeCenter.y -= eyeVerticalOffset
        switch whichEye {
        case .Left: eyeCenter.x -= eyeHorizontolSeperation / 2
        case .Right: eyeCenter.x += eyeHorizontolSeperation / 2
        }
